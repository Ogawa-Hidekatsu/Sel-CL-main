...
from .poisoned_dataset import CIFAR10Poison,MNISTPoison,CIFAR10Poison_original
...
def build_init_data(dataname, download, dataset_path):
    ...
    elif dataname == 'CIFAR10' or 'CIFIR-10':
...
def build_testset(is_train, args, transform_train, transform_test):
    ...
    if args.dataset == 'CIFAR10' or 'CIFIR-10':
...
def build_transform(dataset):
    if dataset == 'CIFAR10' or 'CIFIR-10':
...
def build_poisoned_training_set_original(is_train, args):
    ...
    if args.dataset == 'CIFAR10' or 'CIFAR-10':
